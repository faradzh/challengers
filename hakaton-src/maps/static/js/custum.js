...
;function getInfoBoxBigImage(item) {
    ...
    return new InfoBox({
        content: '<div class="marker_info2 none" id="marker_info2">' + '<div class="info" id="info">' + '<span id="icon-new"></span>' + '<div class="km_time animated fadeIn">' + '<span class="km"><i class="fa fa-level-up"></i>' + item.difficulty + '</span>' + '</div>' + '<div class="info_img"><img src="' + item.map_image_url + '" class="logotype" alt=""/>' + '<h2 style="height:' + marker_h2_height + 'px' + '">' + item.name_point + '<span>' + '<i class="fa fa-star"></i><i class="fa fa-star"></i>' + '<i class="fa fa-star"></i><i class="fa fa-star">' + '</i><i class="fa fa-star"></i>' + '</span><span id="info-price">' + (item.price || 'Free') + ' $' + '</span><span id="info-points">' + item.points + '  <i class="fa fa-trophy"></i>' + '</span></h2></div>' + '<p>' + item.description_point + '</p>' + '<a href="' + item.url_point + '" class="green_btn">' + item.moreinfo + '</a>' + '<span class="arrow"></span>' + '<div class="marker_info_popup"></div>' + '</div>' + '</div>',
        disableAutoPan: true,
        maxWidth: 0,
        pixelOffset: new google.maps.Size(40,-210),
        closeBoxMargin: '50px 200px',
