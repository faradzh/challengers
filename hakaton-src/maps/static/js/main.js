...
function initialize_map() {
    'use strict';
    loadScript('/static/js/infobox.js', after_load);
}
function after_load() {
    'use strict';
    // initialize_new();
            ...
            if (isValidEmailAddress(email.val())) {
                ...
                jQuery.ajax({
                    ...
                    success: function(date) {
                        jQuery('#subscribe_mini_form').append("<div class=\"alert alert-success fade in\">" + "<button class=\"close\" data-dismiss=\"alert\" type=\"button\">&times;</button><strong>" + "" + date + "" + "</strong></div>");
